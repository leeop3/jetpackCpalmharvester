...
export default function CapturePage({ onCapture, onEdit, recentRecords }: CapturePageProps) {
  return (
    <div className="p-4 space-y-8 max-w-2xl mx-auto pb-20">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-500 text-sm font-medium">Take a photo of the harvested bunches to start a new entry</p>
      </div>
